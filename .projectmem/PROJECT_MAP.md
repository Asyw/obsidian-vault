...
- `Scripts/` - helper scripts, including `connect-project-memory.sh` for adding projectmem to another project.
...
- `Scripts/connect-project-memory.sh` - initializes projectmem in a target project and creates/updates the Obsidian project note.
